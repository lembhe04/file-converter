  ...
  return (
    <div className="max-w-7xl h-auto mx-auto  ">
      ...
      <div className="max-w-3xl mx-auto mb-10">
        <h1 className="text-6xl font-extrabold  text-center p-20">File Converter</h1>
        <p className="text-center text-gray-500 mb-20">Convert DOCX to PDF and PDF to DOCX easily.It's an online file converter. We support nearly all audio,
      ...
      <form onSubmit={handleSubmit} className=" ">
       <div className="flex flex-col gap-4   max-w-md mx-auto justify-center items-center ">
         <input
          ...
          className="block  bg-gray-100 hover:text-gray-500 border-gray-100 w-100 rounded-2xl p-4 "
        />

        <select
          value={convertTo}
          onChange={(e) => setConvertTo(e.target.value)}
          className="block border  bg-gray-100 hover:text-gray-500 border-gray-100 w-100 rounded-2xl p-4 "
        >
         ...
         <button
          type="submit"
          disabled={loading}
          className="py-3 mt-8 bg-blue-600 w-100 text-white rounded-2xl disabled:opacity-50 hover:bg-blue-700 hover:text-gray-200"
        >
